...
namespace TareasMVC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Registro(RegistroViewModel modelo)
        {
            ...
            var resutado = await userManager.CreateAsync(usuario, password: modelo.Password);
        ...
        public async Task<IActionResult> RegistrarUsuarioExterno(string urlRetorno = null, string remoteError = null)
        {
            ...
            {
                mensaje = "Error leyendo el email del usuario de proveedor";
                return RedirectToAction("Login", routeValues: new { mensaje });
            }
        ...
        {
            var usuario = await context.Users.Where(u => u.Email.Equals(email)).FirstOrDefaultAsync();
            ...
            return RedirectToAction("Listado", routeValues: new { mensaje = $"Rol asignado correctamente a {usuario.Email}" });
        }
        ...
        public async Task<IActionResult> RemoverAdmin(string email)
        {
            ...
            return RedirectToAction("Listado", routeValues: new { mensaje = $"Rol removido correctamente a {usuario.Email}" });
        }
    }
}
