...
namespace TareasMVC.Controllers
{
    ...
    public class ArchivosController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<ArchivoAdjunto>>> Post(int tareaId, [FromForm] IEnumerable<IFormFile> archivos)
        {
            ...
            var resultados = await almacenadorArchivos.Almacenar(archivos);
            ...
            await context.AddRangeAsync(archivosAdjuntos);
        ...
        public async Task<IActionResult> Delete(Guid id)
        {
            ...
            await almacenadorArchivos.Borrar(archivoAdjunto.Key);
            await context.SaveChangesAsync();
