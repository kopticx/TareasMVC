...
namespace TareasMVC.Controllers
{
    ...
    public class TareasController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<TareaDTO>>> Get()
        {
            ...
            return await context.Tareas.Where(u => u.UsuarioCreacionId == usuarioId).OrderBy(x => x.Orden)
        ...
        public async Task<ActionResult<Tarea>> Post([FromBody] string titulo)
        {
            ...
            if (existenTareas)
            {
                ordenMayor = await context.Tareas.Where(u => u.UsuarioCreacionId == usuarioId).Select(t => t.Orden).MaxAsync();
            }
        ...
        [HttpPost("Ordenar")]
        public async Task<ActionResult> Ordenar([FromBody] int[] ids)
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
